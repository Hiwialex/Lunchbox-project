    ...
    <form action = "showData" method =  "get">
       <h1>Role Of Admin Are To</h1>
         ...
         <ul>
          ...
          <p><input type = "submit" value = "show food Information"></p>
    
    </form>
    <form action = "showDelivery" method = "get">
         <p><input type = "submit" value = "show delivery information">
    </form>
    
    <form action = "showOrderdFood" method = "get">
         <p><input type = "submit" value = "show order information">
         <br>
