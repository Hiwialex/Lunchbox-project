	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (rs.next()) {
				...
				out.println("<p>How many Lunchboxes you want to order</p>");
                ...
                ///We're sorry! Your choice is not available at the moment. Sent us an order depending on your kid's preferences.
			out.println("<center><h1 style = 'color:red'>Pick one from the list for the meantime please...</h1></center");
