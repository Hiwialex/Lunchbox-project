...
public class confirmationOrder extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (foodPrice*items == paidPrice*items) {
			///storing ordered data to internal server
			     try {
			    	    ...
			    	    if (i >0) {
			    	    	 ...
			    	    	 out.println("<center><h2 style = 'color:cyan'>your Lunchbox is on the way please waite a while ....<br><a href = 'order.jsp'>want to order more</a></h2></center>");
			...
			out.println("<center><h1 style = 'color:red'>your balance is insufficient to pay for ordered Lunchbox. please recharge and order</h1><a href = order.jsp>want to order</a><p>thank you for your apply<br><a href = user.jsp>logout</a></center>");
